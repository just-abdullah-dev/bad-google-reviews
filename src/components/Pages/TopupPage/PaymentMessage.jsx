      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-center">
            {paymentStatus === 'COMPLETED' ? trans("successMsg") : trans("failureMsg")}
          </DialogTitle>
        </DialogHeader>
        <div className="mt-6 text-center ">
          {paymentStatus === 'COMPLETED' ? (
            <>
              ...
              <p className="text-xl font-semibold mb-2 ">{trans("thankYou")} {payerName}!</p>
             ...
             <p className="text-lg font-medium mt-8">
              ...
              <p className="text-lg font-medium">
              {trans("p3")}: <span className="text-green-600">{process.env.NEXT_PUBLIC_CURRENCY_SYMBOL} {balance.toFixed(2)}</span>
              </p>
            </>
          ) : (
            <>
              <XCircle className="w-16 h-16 mx-auto text-red-500 mb-4" />
              <p className="text-xl font-semibold mb-2">{trans("errorHeading")}</p>
